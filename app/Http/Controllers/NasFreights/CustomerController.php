...
use App\Http\Requests\NasFreights\Customer\DestroyCustomerRequest;
use App\Http\Requests\NasFreights\Customer\IndexCustomerRequest;
use App\Http\Requests\NasFreights\Customer\ShowCustomerRequest;
use App\Http\Requests\NasFreights\Customer\StoreCustomerRequest;
use App\Http\Requests\NasFreights\Customer\UpdateCustomerRequest;
...
class CustomerController extends Controller
{
    ...
    public function show(ShowCustomerRequest $request, NasFreightsCustomer $customer)
    {
    ...
    public function update(UpdateCustomerRequest $request, NasFreightsCustomer $customer)
    {
        $customer->update([
            'customer_group'         => $request->customer_group,
            'name'                   => $request->name,
    ...
    public function destroy(DestroyCustomerRequest $request, NasFreightsCustomer $customer)
    {
        $customer->delete();
