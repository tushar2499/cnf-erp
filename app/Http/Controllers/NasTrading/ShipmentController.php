    ...
    public function index(Request $request)
    {
        if ($request->ajax()) {
            return DataTables::of(NasTradingShipment::latest())
                ...
                ->addColumn('action', fn ($r) => '<a href="'.route('nas-trading.shipments.show', $r->id).'" class="btn btn-sm btn-outline-info" style="padding:2px 6px;font-size:.7rem"><i class="fa fa-eye"></i></a> '.
