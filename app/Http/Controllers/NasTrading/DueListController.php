    ...
    public function customerDue(Request $request)
    {
        if ($request->ajax()) {
            ...
            return DataTables::of($query)
                ...
                ->addColumn('action', fn ($r) => '<a href="'.route('nas-trading.customer-bills.show', $r->id).'" class="btn btn-sm btn-outline-info" style="padding:2px 6px;font-size:.7rem" title="View"><i class="fa fa-eye"></i></a> '.
