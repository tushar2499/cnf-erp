...
@push('styles')
    <style>
        ...
        #dueTable thead tr:first-child th {
            background: #1a6b60;
            color: #fff;
            font-weight: 600;
            position: sticky;
        ...
        #dueTable thead tr:last-child th {
            background: #f8f9fa;
            font-weight: normal;
            position: sticky;
            z-index: 2;
        ...
        #dueTable thead tr:last-child th input.form-control {
            min-width: 72px;
            width: 100%;
        ...
        .due-table-wrapper::-webkit-scrollbar {
            width: 6px;
            height: 6px;
        }

        .due-table-wrapper::-webkit-scrollbar-track {
            background: #f1f1f1;
        }

        .due-table-wrapper::-webkit-scrollbar-thumb {
            background: #c1c1c1;
            border-radius: 3px;
        }
...
@section('content')
                    ...
                    <div class="dropdown w-100">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li><button class="dropdown-item"
                                    onclick="$('#dueTable').DataTable().button('.buttons-csv').trigger()"><i
                                        class="fa fa-file-csv me-2 text-secondary"></i>CSV</button></li>
                            <li><button class="dropdown-item"
                                    onclick="$('#dueTable').DataTable().button('.buttons-excel').trigger()"><i
                                        class="fa fa-file-excel me-2 text-success"></i>Excel</button></li>
                            <li><button class="dropdown-item"
                                    onclick="$('#dueTable').DataTable().button('.buttons-pdf').trigger()"><i
                                        class="fa fa-file-pdf me-2 text-danger"></i>PDF</button></li>
                            <li>
                                <hr class="dropdown-divider">
                            </li>
                            <li><button class="dropdown-item"
                                    onclick="$('#dueTable').DataTable().button('.buttons-print').trigger()"><i
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center"
            ...
            <span><i class="fa fa-list me-2"></i> Confirmed Bills — Awaiting Payment</span>
...
@push('scripts')
    <script>
        ...
        var table = $('#dueTable').DataTable({
            ...
            language: {
                emptyTable: '<div class="text-center py-3 text-muted"><i class="fa fa-check-circle fa-2x mb-2 d-block text-success"></i>No confirmed outstanding bills.</div>'
            },
