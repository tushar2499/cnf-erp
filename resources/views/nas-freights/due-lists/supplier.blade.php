...
<div class="card">
    <div class="card-header" style="background:#0c2340;color:#fff;font-size:.85rem;">
        <i class="fa fa-list me-2"></i> Confirmed Payment Orders — Awaiting Payment
...
<script>
$('#fldSupplier').select2({
    theme: 'bootstrap-5', placeholder: 'All Suppliers', minimumInputLength: 3, allowClear: true,
    ajax: {
...
var table = $('#dueTable').DataTable({
    ...
    language: { emptyTable: '<div class="text-center py-3 text-muted"><i class="fa fa-check-circle fa-2x mb-2 d-block text-success"></i>No confirmed outstanding payment orders.</div>' },
