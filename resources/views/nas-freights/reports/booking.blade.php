        ...
        <div class="filter-card">
            <div class="row g-2">
                ...
                <div class="col-md-3">
                    ...
                    <input type="hidden" name="customer_name" id="customer_name_val"
                ...
                <div class="col-md-3">
                    ...
                    <input type="hidden" name="supplier_name" id="supplier_name_val"
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" name="vehicle" class="form-control form-control-sm" placeholder="Cover Van No..."
                        value="{{ request('vehicle') }}">
                </div>
                <div class="col-md-3">
                    <label class="form-label fw-semibold mb-1" style="font-size:12px">Location From</label>
                    <input type="text" name="location_from" class="form-control form-control-sm"
                        placeholder="Location from..." value="{{ request('location_from') }}">
                </div>
                ...
                <tbody>
                    @foreach ($rows as $i => $item)
                        @php
                            $b = $item->booking;
                            $loc = trim(
                                ($item->location_from ?? '') . ($item->location_to ? ' - ' . $item->location_to : ''),
                            );
