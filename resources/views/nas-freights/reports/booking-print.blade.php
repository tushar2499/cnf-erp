    ...
    <div class="page">
        ...
        <div class="date-bar">
            @if (request('from_date') || request('to_date'))
                <span><strong>From Date:</strong> &nbsp;
                    {{ request('from_date') ? \Carbon\Carbon::parse(request('from_date'))->format('d/m/Y') : '—' }}</span>
                <span><strong>To Date:</strong> &nbsp;
                    {{ request('to_date') ? \Carbon\Carbon::parse(request('to_date'))->format('d/m/Y') : '—' }}</span>
            @endif
            @if (request('customer_name'))
                <span><strong>Customer:</strong> {{ request('customer_name') }}</span>
            @endif
            @if (request('supplier_name'))
                <span><strong>Supplier:</strong> {{ request('supplier_name') }}</span>
            @endif
            @if (request('vehicle'))
        ...
        <div class="powered">
            <table>
                <tr>
                    <td>Powered By:
                        <a href="https://a4bbd.com/" style="color:#888;text-decoration:none">
