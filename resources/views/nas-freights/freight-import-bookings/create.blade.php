...
@section('content')
            ...
            <div class="section-body">
                <div class="row g-2 mb-2">
                    <div class="col-md-2">
                        ...
                        <input type="text" class="form-control fb-input bg-light"
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="date" name="booking_date" class="form-control fb-input"
                ...
                <div class="row g-2 mb-2">
                    <div class="col-md-4">
                        <div class="fb-label">MOD/Service Type <span class="text-danger">*</span></div>
                ...
                <div class="row g-2 mb-2">
                    <div class="col-md-3">
                        ...
                        <input type="text" name="pol" class="form-control fb-input"
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" name="place_of_receipt" class="form-control fb-input"
                            value="{{ old('place_of_receipt', $freightBooking?->place_of_receipt) }}"
                            placeholder="e.g. Shanghai">
                    </div>
                    <div class="col-md-3">
                        <div class="fb-label">Place of Delivery</div>
                        <input type="text" name="place_of_delivery" class="form-control fb-input"
                            value="{{ old('place_of_delivery', $freightBooking?->place_of_delivery) }}"
                ...
                <div class="row g-2 mb-2">
                    <div class="col-md-3">
                        ...
                        <input type="text" name="vessel_name" class="form-control fb-input"
                            value="{{ old('vessel_name', $freightBooking?->vessel_name) }}" placeholder="e.g. MSC ANNA">
                    </div>
                    <div class="col-md-2">
                        <div class="fb-label">Voyage No</div>
                        <input type="text" name="voyage_no" class="form-control fb-input"
                            value="{{ old('voyage_no', $freightBooking?->voyage_no) }}" placeholder="e.g. 024W">
                    </div>
                    <div class="col-md-2">
                        <div class="fb-label">B/L No</div>
                        <input type="text" name="bl_no" class="form-control fb-input"
                            value="{{ old('bl_no', $freightBooking?->bl_no) }}" placeholder="e.g. MSLU-024W-0001">
                    </div>
                    <div class="col-md-2">
                        <div class="fb-label">IGM No</div>
                        <input type="text" name="igm_no" class="form-control fb-input"
                            value="{{ old('igm_no', $freightBooking?->igm_no) }}" placeholder="e.g. 2026-001234">
                    </div>
                    <div class="col-md-3">
                        <div class="fb-label">Delivery Order (DO) No</div>
                        <input type="text" name="delivery_order_no" class="form-control fb-input"
                            value="{{ old('delivery_order_no', $freightBooking?->delivery_order_no) }}"
                ...
                <div class="row g-2">
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="date" name="eta" class="form-control fb-input"
                            value="{{ old('eta', $freightBooking?->eta?->format('Y-m-d')) }}">
                    </div>
                    <div class="col-md-4">
                        <div class="fb-label">Commodity Description</div>
                        <input type="text" name="commodity_description" class="form-control fb-input"
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="text" name="remarks" class="form-control fb-input"
    ...
    <template id="itemTemplate">
        <tr>
            ...
            <td><input type="text" name="items[0][hs_code]" class="form-control form-control-sm"
                    style="font-size:.72rem;" placeholder="e.g. 4203.21"></td>
            <td><input type="text" name="items[0][commodity]" class="form-control form-control-sm"
                    style="font-size:.72rem;" placeholder="e.g. Leather jackets"></td>
            ...
            <td><input type="text" name="items[0][country_of_origin]" class="form-control form-control-sm"
                    style="font-size:.72rem;" placeholder="e.g. China"></td>
            <td>
