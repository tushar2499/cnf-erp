            ...
            <div class="p-3">
                <div class="row g-2 align-items-end">
                    <div class="col-md-2">
                        ...
                        <input type="date" id="fldFromDate" class="form-control form-control-sm"
                            value="{{ date('Y-m-01') }}" required>
                    </div>
                    <div class="col-md-2">
                        <label class="form-label">To Date <span class="req">*</span></label>
                        <input type="date" id="fldToDate" class="form-control form-control-sm"
        ...
        <div id="billHeaderSection" style="display:none">
                ...
                <div class="p-3">
                    <div class="row g-2">
                        <div class="col-md-3">
                            ...
                            <input type="date" id="fldBillDate" name="bill_date" class="form-control form-control-sm"
                                value="{{ date('Y-m-d') }}" required>
                        </div>
                        <div class="col-md-3">
            ...
            <div class="d-flex justify-content-between align-items-center mb-2 px-1 flex-wrap gap-2">
                <div class="total-bar d-flex gap-4 align-items-center">
                    ...
                    <span style="font-size:.85rem">Total Amount: <strong id="fldTotalDisplay"
                            class="text-success">0.00</strong></span>
                </div>
                ...
                <table class="table table-bordered table-hover mb-0" id="rowsTable">
                    ...
                    <tfoot>
                        <tr style="background:#f1f5f9; font-weight:600;">
                            <td colspan="13" class="text-end" style="font-size:.8rem; padding:.4rem .5rem;">Total
                                Amount:</td>
                            <td class="text-end text-success" id="fldTotalAmt"
                                style="font-size:.85rem; padding:.4rem .5rem;">0.00</td>
                            <td></td>
                        </tr>
                    </tfoot>
                </table>
    ...
    <script>
        ...
        $('#btnLoadData').on('click', function() {
            ...
            $.ajax({
                ...
                .fail(function(xhr) {
                    Swal.fire({
                        icon: 'error',
                        title: xhr.responseJSON?.message || 'Failed to load data.'
                    });
                })
                .always(function() {
        ...
        $('#billForm').on('submit', function(e) {
            ...
            if ($('#rowsBody tr').length === 0) {
                Swal.fire({
                    icon: 'warning',
                    title: 'Add at least one item row.'
                });
                return;
            }
