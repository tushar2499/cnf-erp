    ...
    <script>
        $(function() {
            var table = $('#billsTable').DataTable({
                ...
                ajax: {
                    url: '{{ route('nas-freights.supplier-bills.index') }}',
                    data: function(d) {
                ...
                language: {
                    emptyTable: '<div class="text-center py-3 text-muted"><i class="fa fa-file-invoice fa-2x mb-2 d-block"></i>No payment orders yet.</div>'
                },
            ...
            $(document).on('click', '.btn-confirm', function() {
                const url = $(this).data('url'),
                    name = $(this).data('name');
                Swal.fire({
                        title: 'Confirm payment order "' + name + '"?',
                        text: 'Will be marked as Confirmed and appear in Due List.',
                        icon: 'question',
