...
@section('title', 'Import Supplier Payments')
...
<div class="page-header">
    <h4><i class="fa fa-file-import me-2 text-info"></i> Import Supplier Payments</h4>
</div>
...
<div class="import-card mb-3">
    ...
    <div class="p-3">
        <form method="POST" action="{{ route('nas-freights.import.supplier-payments.preview') }}" enctype="multipart/form-data">
            @csrf
            <div class="row g-3 align-items-end">
                <div class="col-md-6">
                    ...
                    <div class="form-text">Expected columns: Payment Date, Payment No, Supplier, Total Amount, Branch Name, Status, Comments, Entry By</div>
                </div>
...
<div class="import-card">
    ...
    <div class="p-3">
        ...
        <form method="POST" action="{{ route('nas-freights.import.supplier-payments.import') }}">
            @csrf
            <input type="hidden" name="file_path" value="{{ $storedPath }}">
            <button type="submit" class="btn btn-success btn-sm">
                <i class="fa fa-check me-1"></i> Confirm Import ({{ $total }} rows)
            </button>
            <a href="{{ route('nas-freights.import.supplier-payments') }}" class="btn btn-secondary btn-sm ms-2">
