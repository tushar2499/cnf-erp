...
@push('styles')
    <style>
        ...
        #agentsTable thead tr:first-child th {
            background: #e9ecef;
            font-weight: 600;
            position: sticky;
            top: 0;
        ...
        #agentsTable thead tr:last-child th {
            background: #f8f9fa;
            font-weight: normal;
            position: sticky;
            z-index: 2;
        ...
        #agentsTable thead tr:last-child th input.form-control {
            min-width: 120px;
            width: 100%;
        ...
        .agents-table-wrapper::-webkit-scrollbar {
            width: 6px;
            height: 6px;
        }

        .agents-table-wrapper::-webkit-scrollbar-track {
            background: #f1f1f1;
        }

        .agents-table-wrapper::-webkit-scrollbar-thumb {
            background: #c1c1c1;
            border-radius: 3px;
        }

        #agentsTable_wrapper>.row:last-child {
            position: sticky;
            bottom: 0;
            background: #fff;
            z-index: 3;
...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-2">
        <span><i class="fa fa-list me-2"></i> All Overseas Agents</span>
        <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
                <li><button class="dropdown-item"
                        onclick="$('#agentsTable').DataTable().button('.buttons-csv').trigger()"><i
                            class="fa fa-file-csv me-2 text-secondary"></i>CSV</button></li>
                <li><button class="dropdown-item"
                        onclick="$('#agentsTable').DataTable().button('.buttons-excel').trigger()"><i
                            class="fa fa-file-excel me-2 text-success"></i>Excel</button></li>
                <li><button class="dropdown-item"
                        onclick="$('#agentsTable').DataTable().button('.buttons-pdf').trigger()"><i
                            class="fa fa-file-pdf me-2 text-danger"></i>PDF</button></li>
                <li>
                    <hr class="dropdown-divider">
                </li>
                <li><button class="dropdown-item"
                        onclick="$('#agentsTable').DataTable().button('.buttons-print').trigger()"><i
    ...
    <div class="card-body p-0">
        <div class="agents-table-wrapper">
            <table id="agentsTable" class="table table-hover table-striped table-bordered mb-0">
                <thead>
                    <tr>
                        <th>#</th>
                        <th>Code</th>
...
$(function () {
    table = $('#agentsTable').DataTable({
        ...
        columns: [
            ...
            { data: 'city',           name: 'city',           width: '100px' },
            { data: 'contact_person', name: 'contact_person', width: '130px' },
        ...
        initComplete: function () {
            const firstRowH = $('#agentsTable thead tr:first-child').outerHeight();
            $('#agentsTable thead tr:last-child th').css('top', firstRowH + 'px');
