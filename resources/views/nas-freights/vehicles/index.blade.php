...
@push('styles')
    ...
    <style>
        ...
        #vehiclesTable thead tr:first-child th {
            background: #1a6b60;
            color: #fff;
            font-weight: 600;
            position: sticky;
        ...
        #vehiclesTable thead tr:last-child th {
            background: #f8f9fa;
            font-weight: normal;
            position: sticky;
            z-index: 2;
        ...
        #vehiclesTable thead tr:last-child th input.form-control {
            min-width: 72px;
            width: 100%;
        ...
        #vehiclesTable_wrapper>.row:last-child {
            position: sticky;
            bottom: 0;
            background: #fff;
            z-index: 3;
        ...
        .veh-tabs .nav-link:hover:not(.active) {
            color: #0284c7;
...
@section('content')
    <div class="page-header">
        ...
        <button class="btn btn-sm btn-info text-white" id="btnAddNew" data-bs-toggle="modal"
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    <li><button class="dropdown-item"
                            onclick="$('#vehiclesTable').DataTable().button('.buttons-csv').trigger()"><i
                                class="fa fa-file-csv me-2 text-secondary"></i>CSV</button></li>
                    <li><button class="dropdown-item"
                            onclick="$('#vehiclesTable').DataTable().button('.buttons-excel').trigger()"><i
                                class="fa fa-file-excel me-2 text-success"></i>Excel</button></li>
                    <li><button class="dropdown-item"
                            onclick="$('#vehiclesTable').DataTable().button('.buttons-pdf').trigger()"><i
                                class="fa fa-file-pdf me-2 text-danger"></i>PDF</button></li>
                    <li>
                        <hr class="dropdown-divider">
                    </li>
                    <li><button class="dropdown-item"
                            onclick="$('#vehiclesTable').DataTable().button('.buttons-print').trigger()"><i
                                class="fa fa-print me-2"></i>Print</button></li>
                </ul>
            </div>
        </div>
        <div class="card-body p-0">
            <div class="veh-table-wrapper">
                <table id="vehiclesTable" class="table table-hover table-striped table-bordered mb-0">
                    <thead>
                        <tr>
                            <th>#</th>
                            <th>Vehicle No.</th>
    ...
    <div class="modal fade" id="vehicleModal" tabindex="-1" aria-labelledby="vehicleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header" style="background:#0c2340;color:#fff;padding:.65rem 1rem;">
                    <h6 class="modal-title fw-bold mb-0" id="vehicleModalLabel">
                ...
                {{-- Tabs --}}
                <ul class="nav veh-tabs border-bottom px-3 pt-1" style="background:#f0f8ff;">
                    <li class="nav-item">
                        <a class="nav-link active" data-bs-toggle="tab" href="#tabEntry">
                            <i class="fa fa-car me-1"></i> Vehicle Entry
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tab" href="#tabImage">
                            ...
                            <div class="tab-pane fade show active" id="tabEntry">
                                <div class="row g-2">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" id="vehNumber" class="form-control form-control-sm"
                                            placeholder="e.g. DHA-1234-A">
                                        <div class="invalid-feedback" id="vehNumberErr"></div>
                                    </div>

                                    <div class="col-md-6">
                                        <label class="form-label">Vehicle Name</label>
                                        <input type="text" id="vehName" class="form-control form-control-sm"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select id="vehSupplier" class="form-select form-select-sm"
                                            style="width:100%">
                                            <option value="">Enter (Code or Name) min 3 chars</option>
                                        </select>
                                    </div>

                                    <div class="col-md-6">
                                        <label class="form-label">Price</label>
                                        <input type="number" id="vehPrice" class="form-control form-control-sm"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <textarea id="vehDesc" class="form-control form-control-sm" rows="1"
                                    ...
                                    <div class="col-12">
                                        <div class="d-flex gap-4 mt-1">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="vehAvailPO"
                                                    checked>
                                                <label class="form-check-label" for="vehAvailPO"
                                                    style="font-size:.82rem;font-weight:600">Availability In
                                                    PO</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="vehAvailSO"
                                                    checked>
                                                <label class="form-check-label" for="vehAvailSO"
                                                    style="font-size:.82rem;font-weight:600">Availability In
                                                    SO</label>
                                            </div>
                                        </div>
                            ...
                            <div class="tab-pane fade" id="tabImage">
                                <div class="text-center mb-2 pt-2">
                                    ...
                                    <div class="img-preview-box" id="imgPreviewBox"
                                        onclick="$('#vehImage').click()">
                                        <div id="imgPlaceholder" class="text-muted text-center">
                                            <i class="fa fa-cloud-upload-alt fa-2x mb-2 d-block"
                                                style="color:#9ca3af"></i>
                                            <small>Click to upload image<br><span
                                                    style="font-size:.7rem">JPG, PNG, GIF — max 2MB</span></small>
                                        </div>
                                        <img id="imgPreview" src="" style="display:none">
                                    </div>
                                    <input type="file" id="vehImage" name="image" class="d-none"
                                        accept="image/*">
    ...
    <script>
        ...
        $(function() {
            ...
            table = $('#vehiclesTable').DataTable({
                ...
                language: {
                    emptyTable: '<div class="text-center py-3 text-muted"><i class="fa fa-truck fa-2x mb-2 d-block"></i>No vehicles yet.</div>'
                },
                initComplete: function() {
                    const firstRowH = $('#vehiclesTable thead tr:first-child').outerHeight();
                    $('#vehiclesTable thead tr:last-child th').css('top', firstRowH + 'px');
            ...
            function resetForm() {
                ...
                clearErrors();
                $('#vehicleModalLabel').html('<i class="fa fa-plus me-2"></i> Add New Vehicle');
                $('#btnSave').html('<i class="fa fa-save me-1"></i> Save');
                $('[data-bs-toggle="tab"][href="#tabEntry"]').tab('show');
            }
            ...
            $('#vehicleModal').on('hidden.bs.modal', resetForm);
            ...
            $(document).on('click', '.btn-edit', function() {
                ...
                $.getJSON('{{ url('nas-freights/vehicles') }}/' + id, function(r) {
                    ...
                    $('#vehicleModalLabel').html('<i class="fa fa-edit me-2"></i> Edit Vehicle');
            ...
            $('#vehicleForm').on('submit', function(e) {
                ...
                let valid = true;
                if (!$('#vehNumber').val().trim()) {
                    $('#vehNumber').addClass('is-invalid');
                    $('#vehNumberErr').text('Vehicle number is required.');
                    valid = false;
                }
                if (!$('#vehClass').val()) {
                    $('#vehClass').addClass('is-invalid');
                    $('#vehClassErr').text('Vehicle class is required.');
                    valid = false;
                }
                if (!$('#vehType').val()) {
                    $('#vehType').addClass('is-invalid');
                    $('#vehTypeErr').text('Vehicle type is required.');
                    valid = false;
                }
                if (!valid) return;
                ...
                const id = $('#vehId').val();
                const url = id ?
                    '{{ url('nas-freights/vehicles') }}/' + id :
                    '{{ route('nas-freights.vehicles.store') }}';
                    ...
                    .fail(function(xhr) {
                        if (xhr.status === 422) {
                            ...
                            if (errors.vehicle_number) {
                                $('#vehNumber').addClass('is-invalid');
                                $('#vehNumberErr').text(errors.vehicle_number[0]);
                            }
                            if (errors.vehicle_class) {
                                $('#vehClass').addClass('is-invalid');
                                $('#vehClassErr').text(errors.vehicle_class[0]);
                            }
                            if (errors.vehicle_type) {
                                $('#vehType').addClass('is-invalid');
                                $('#vehTypeErr').text(errors.vehicle_type[0]);
                            }
                            if (errors.purchase_unit) {
                                $('#vehUnit').addClass('is-invalid');
                                $('#vehUnitErr').text(errors.purchase_unit[0]);
                            }
                        } else {
                            Swal.fire({
                                icon: 'error',
