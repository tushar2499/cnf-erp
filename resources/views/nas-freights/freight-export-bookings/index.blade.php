...
@push('styles')
    <style>
        #exportBookingsTable th,
        #exportBookingsTable td {
            white-space: nowrap;
            font-size: .73rem;
            padding: .3rem .5rem;
        }

        #exportBookingsTable thead tr:first-child th {
            background: #e9ecef;
            font-weight: 600;
            position: sticky;
            top: 0;
        ...
        #exportBookingsTable thead tr:last-child th {
            background: #f8f9fa;
            font-weight: normal;
            position: sticky;
            z-index: 2;
        ...
        #exportBookingsTable thead tr:last-child th input.form-control {
            min-width: 72px;
            width: 100%;
        ...
        #exportBookingsTable_wrapper>.row:last-child {
            position: sticky;
            bottom: 0;
            background: #fff;
            z-index: 3;
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-2">
            <div class="d-flex gap-1 flex-wrap align-items-center">
                <span class="me-2 fw-semibold"><i class="fa fa-list me-1"></i> All Export Bookings</span>
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li><button class="dropdown-item"
                                onclick="$('#exportBookingsTable').DataTable().button('.buttons-csv').trigger()"><i
                                    class="fa fa-file-csv me-2 text-secondary"></i>CSV</button></li>
                        <li><button class="dropdown-item"
                                onclick="$('#exportBookingsTable').DataTable().button('.buttons-excel').trigger()"><i
                                    class="fa fa-file-excel me-2 text-success"></i>Excel</button></li>
                        <li><button class="dropdown-item"
                                onclick="$('#exportBookingsTable').DataTable().button('.buttons-pdf').trigger()"><i
                                    class="fa fa-file-pdf me-2 text-danger"></i>PDF</button></li>
                        <li>
                            <hr class="dropdown-divider">
                        </li>
                        <li><button class="dropdown-item"
                                onclick="$('#exportBookingsTable').DataTable().button('.buttons-print').trigger()"><i
        ...
        <div class="card-body p-0">
            <div class="export-table-wrapper">
                <table id="exportBookingsTable" class="table table-hover table-striped table-bordered mb-0">
                    <thead>
                        <tr>
                            <th>#</th>
                            <th>Booking No</th>
        ...
        $(function() {
            ...
            var table = $('#exportBookingsTable').DataTable({
                ...
                columns: [{
                    ...
                    {
                        data: 'export_booking_no',
                        name: 'export_booking_no'
                    },
                    {
                        data: 'booking_date',
                        name: 'booking_date'
                ...
                initComplete: function() {
                    const firstRowH = $('#exportBookingsTable thead tr:first-child').outerHeight();
                    $('#exportBookingsTable thead tr:last-child th').css('top', firstRowH + 'px');
