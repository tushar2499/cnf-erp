    ...
    <form method="POST"
        ...
        <div class="section-card">
            ...
            <div class="section-body">
                ...
                {{-- Row 6: Trade Documents & Remarks --}}
                <div class="row g-2">
                    <div class="col-md-2">
                        <div class="fb-label">EXP No</div>
                        <input type="text" name="exp_no" class="form-control fb-input"
                            value="{{ old('exp_no', $exportBooking?->exp_no) }}" placeholder="e.g. EXP-2024-0001">
                    </div>
                    <div class="col-md-2">
                        <div class="fb-label">EXP Date</div>
                        <input type="date" name="exp_date" class="form-control fb-input"
                            value="{{ old('exp_date', $exportBooking?->exp_date?->format('Y-m-d')) }}">
                    </div>
                    <div class="col-md-2">
                        <div class="fb-label">Invoice No</div>
                        <input type="text" name="invoice_no" class="form-control fb-input"
                            value="{{ old('invoice_no', $exportBooking?->invoice_no) }}"
                            placeholder="e.g. INV-2024-0001">
                    </div>
                    <div class="col-md-2">
                        <div class="fb-label">Invoice Date</div>
                        <input type="date" name="invoice_date" class="form-control fb-input"
                            value="{{ old('invoice_date', $exportBooking?->invoice_date?->format('Y-m-d')) }}">
                    </div>
                    <div class="col-md-2">
                        <div class="fb-label">LC No</div>
                        <input type="text" name="lc_no" class="form-control fb-input"
