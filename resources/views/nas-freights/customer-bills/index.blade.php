...
$(function () {
    var table = $('#billsTable').DataTable({
        ...
        language: { emptyTable: '<div class="text-center py-3 text-muted"><i class="fa fa-file-invoice fa-2x mb-2 d-block"></i>No bills yet.</div>' },
    ...
    $(document).on('click', '.btn-confirm', function () {
        ...
        Swal.fire({ title: 'Confirm bill "' + name + '"?', text: 'Bill will be marked as Confirmed and appear in Due List.', icon: 'question', showCancelButton: true, confirmButtonColor: '#198754', confirmButtonText: 'Yes, confirm' })
            .then(res => {
                if (res.isConfirmed) {
