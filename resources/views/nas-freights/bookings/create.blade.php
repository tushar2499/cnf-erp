    ...
    <form id="bookingForm" method="POST" action="{{ route('nas-freights.bookings.store') }}">
                    ...
                    <div class="col-md-6">
                        <div class="row g-2">
                            ...
                            <div class="col-12">
                                ...
                                <input type="date" name="job_date" id="fldJobDate" class="form-control form-control-sm"
                                    value="{{ date('Y-m-d') }}">
                                <div class="invalid-feedback">Required.</div>
                            </div>
                            <div class="col-12">
                                ...
                                <div class="input-group input-group-sm">
                                    <select id="fldCustomer" class="form-select form-select-sm"
                                        style="width:calc(100% - 60px)">
                                        <option value="">Search customer (min 3 chars)</option>
                                    </select>
                                    <button type="button" class="btn btn-success btn-sm px-2" data-bs-toggle="modal"
                                        data-bs-target="#quickCustomerModal" title="Add Customer">Add</button>
                                </div>
                    ...
                    <div class="col-md-6">
                        <div class="row g-2">
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control form-control-sm bg-light" value="Auto Entry"
                                    readonly>
                            </div>
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" name="invoice_no" id="fldInvoiceNo"
                                    class="form-control form-control-sm">
                            </div>
                            <div class="col-12">
                                <label class="form-label"><span class="req">*</span> Delivery Date</label>
                                <input type="date" name="delivery_date" id="fldDeliveryDate"
                                    class="form-control form-control-sm" value="{{ date('Y-m-d') }}">
                                <div class="invalid-feedback">Required.</div>
                            </div>
                            <div class="col-12">
                                <label class="form-label">P/O Number</label>
                                <input type="text" name="po_number" id="fldPoNumber"
                                    class="form-control form-control-sm">
                            </div>
                            <div class="col-12">
                                <label class="form-label"><span class="req">*</span> <span style="color:#1a6b60">Cover
                                        Van No:</span></label>
        ...
        <div class="booking-card">
            ...
            <div style="overflow-x:auto">
                ...
                <div class="total-bar" style="border-top-color:#4a3060">Total Products: <span id="totalProducts">0</span>
                </div>
            </div>
        </div>
                ...
                <div class="d-flex justify-content-end">
                    <table style="width:520px;border-collapse:collapse">
                        <tr>
                            ...
                            <td class="py-1"><input type="text" name="tds_section" id="fldTdsSection"
                        ...
                        <tr>
                            ...
                            <td class="py-1">
                                <div class="input-group input-group-sm">
                                    <input type="number" name="tds_percent" id="fldTdsPct"
                                        class="form-control form-control-sm" value="0" min="0"
                                        step="0.01" oninput="recalc()" onchange="recalc()">
                                    <input type="number" name="tds_amount" id="fldTdsAmt"
                        ...
                        <tr>
                            ...
                            <td class="py-1">
                                <div class="input-group input-group-sm">
                                    <input type="number" name="vat_percent" id="fldVatPct"
                                        class="form-control form-control-sm" value="0" min="0"
                                        step="0.01" oninput="recalc()" onchange="recalc()">
                                    <input type="number" name="vat_amount" id="fldVatAmt"
                                        class="form-control form-control-sm bg-light" readonly value="0"
                                        placeholder="Vat Amt">
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="py-1">
                                <div class="input-group input-group-sm">
                                    <input type="number" name="ait_percent" id="fldAitPct"
                                        class="form-control form-control-sm" value="0" min="0"
                                        step="0.01" oninput="recalc()" onchange="recalc()">
                                    <input type="number" name="ait_amount" id="fldAitAmt"
                                        class="form-control form-control-sm bg-light" readonly value="0"
                                        placeholder="AIT Amt">
                                </div>
                            </td>
                        ...
                        <tr>
                            <td class="text-end pe-2 py-1"><label class="form-label mb-0 fw-bold"
                                    style="color:#dc3545">Total Amount</label></td>
                            <td class="py-1"><input type="number" name="total_amount" id="fldTotalAmt"
                                    class="form-control form-control-sm bg-light fw-bold" readonly value="0"
                                    style="color:#dc3545"></td>
                        </tr>
                    </table>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <form id="quickCusForm">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-sm btn-success" id="btnQcSave"><i
    ...
    <script>
        ...
        $(function() {
            ...
            $('#fldCoverVan').select2({
                ...
                allowClear: true,
                ajax: {
                    url: '{{ route('nas-freights.bookings.search-vehicles') }}',
                    dataType: 'json',
                    delay: 300,
                    data: p => ({
                        q: p.term
            ...
            function addProductRow(item) {
                ...
                const qtyUnitOpts = '<option value="">--Unit--</option>' +
                    qtyUnits.map(u =>
                        `<option value="${u}" ${u === (p.qty_unit||'') ? 'selected' : ''}>${u}</option>`).join('');
                const wtUnitOpts = '<option value="">--Unit--</option>' +
                    weightUnits.map(u =>
                        `<option value="${u}" ${u === (p.weight_unit||'') ? 'selected' : ''}>${u}</option>`).join(
                        '');
                const row = `
        <tr data-prow="${productCount}">
            ...
            function reindexProductSL() {
                $('#productsBody tr').each(function(i) {
                    $(this).find('.psl-no').text(i + 1);
                });
            ...
            function addRow(vanNo, capacity) {
                ...
                const supplierOpts = '<option value="">--Select Supplier--</option>' +
                    suppliers.map(s =>
                        `<option value="${s.id}" data-name="${s.company_name}">${s.code} — ${s.company_name}</option>`
                        ).join('');
        ...
        <tr data-row="${rowCount}">
            ...
            <td><input type="text" name="items[${rowCount}][challan_no]" class="form-control form-control-sm" value="" placeholder="Challan No"></td>
            <td><input type="text" name="items[${rowCount}][capacity]" class="form-control form-control-sm" value="" placeholder="Capacity"></td>
            <td>
            ...
            <td><input type="number" name="items[${rowCount}][qty]" class="form-control form-control-sm row-qty" value="1" min="0" step="0.01" placeholder="0"></td>
            <td><input type="number" name="items[${rowCount}][supplier_rate]" class="form-control form-control-sm row-sup-rate" value="0" min="0" step="0.01" placeholder="0.00"></td>
            <td><input type="number" name="items[${rowCount}][customer_rate]" class="form-control form-control-sm row-cus-rate" value="0" min="0" step="0.01" placeholder="0.00"></td>
            <td><input type="number" name="items[${rowCount}][demurrage_days]" class="form-control form-control-sm" value="0" min="0" placeholder="0"></td>
            <td><input type="number" name="items[${rowCount}][cus_demurrage_charge]" class="form-control form-control-sm" value="0" min="0" step="0.01" placeholder="0.00"></td>
            <td><input type="number" name="items[${rowCount}][sup_demurrage_charge]" class="form-control form-control-sm" value="0" min="0" step="0.01" placeholder="0.00"></td>
            <td><input type="number" name="items[${rowCount}][amount]" class="form-control form-control-sm row-amount bg-light" readonly value="0" placeholder="0.00"></td>
            <td><input type="text" name="items[${rowCount}][location_from]" class="form-control form-control-sm" placeholder="From"></td>
            <td><input type="text" name="items[${rowCount}][location_to]" class="form-control form-control-sm" placeholder="To"></td>
        </tr>`;
                $('#rowsBody').append(row);
            ...
            $('#quickCusForm').on('submit', function(e) {
                ...
                $.post('{{ route('nas-freights.stakeholders.customers.store') }}', {
                    ...
                    Swal.fire({
                        ...
                        position: 'top-end',
                        icon: 'success',
                        title: 'Customer added. Search to select.',
            ...
            $('#bookingForm').on('submit', function(e) {
                ...
                let valid = true;
                if (!$('#fldPrefix').val()) {
                    $('#fldPrefix').addClass('is-invalid');
                    valid = false;
                }
                if (!$('#fldSalesType').val()) {
                    $('#fldSalesType').addClass('is-invalid');
                    valid = false;
                }
                if (!$('#fldJobDate').val()) {
                    $('#fldJobDate').addClass('is-invalid');
                    valid = false;
                }
                if (!$('#fldCustomerId').val()) {
                    $('#fldCustomer').addClass('is-invalid');
                    $('#customerErr').show();
                    valid = false;
                }
                if (!$('#fldDeliveryDate').val()) {
                    $('#fldDeliveryDate').addClass('is-invalid');
                    valid = false;
                }
                if ($('#rowsBody tr').length === 0) {
                    Swal.fire({
                        icon: 'warning',
                        title: 'Add at least one Cover Van row.'
                    });
                    valid = false;
                }
                if (!valid) return;
