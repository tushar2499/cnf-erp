...
<div class="pt-2 pb-4">
    ...
    @php
        ...
        $freightOpsActive      = request()->routeIs('nas-freights.rfqs.*', 'nas-freights.freight-bookings.*');
    ...
    <div class="nav-item-group">
        ...
        <a href="#freightOperationsMenu"
            class="nav-link {{ $operationsActive ? 'active' : '' }}"
            data-bs-toggle="collapse" aria-expanded="{{ $operationsActive ? 'true' : 'false' }}" aria-controls="freightOperationsMenu">
            <i class="fa fa-truck"></i><span> Operations</span>
    ...
    <div class="nav-item-group">
        ...
        <a href="#freightFreightOpsMenu"
            class="nav-link {{ $freightOpsActive ? 'active' : '' }}"
            data-bs-toggle="collapse" aria-expanded="{{ $freightOpsActive ? 'true' : 'false' }}" aria-controls="freightFreightOpsMenu">
            <i class="fa fa-ship"></i><span> Freight Ops</span>
            <i class="fa fa-chevron-down ms-auto"></i>
        </a>
        <div class="collapse {{ $freightOpsActive ? 'show' : '' }}" id="freightFreightOpsMenu">
    ...
    <div class="nav-item-group">
        ...
        <a href="#freightDueListMenu"
            class="nav-link {{ $dueListsActive ? 'active' : '' }}"
            data-bs-toggle="collapse" aria-expanded="{{ $dueListsActive ? 'true' : 'false' }}" aria-controls="freightDueListMenu">
    ...
    <div class="nav-item-group">
        ...
        <a href="#freightCollectionsMenu"
            class="nav-link {{ $collectionsActive ? 'active' : '' }}"
            data-bs-toggle="collapse" aria-expanded="{{ $collectionsActive ? 'true' : 'false' }}" aria-controls="freightCollectionsMenu">
    ...
    <div class="nav-item-group">
        ...
        <a href="#freightReportsMenu"
            class="nav-link {{ $reportsActive ? 'active' : '' }}"
            data-bs-toggle="collapse" aria-expanded="{{ $reportsActive ? 'true' : 'false' }}" aria-controls="freightReportsMenu">
    ...
    <div class="nav-item-group">
        ...
        <a href="#freightStakeholdersMenu"
            class="nav-link {{ $stakeholdersActive ? 'active' : '' }}"
            data-bs-toggle="collapse" aria-expanded="{{ $stakeholdersActive ? 'true' : 'false' }}" aria-controls="freightStakeholdersMenu">
    ...
    <div class="nav-item-group">
        ...
        <a href="#freightImportMenu"
            class="nav-link {{ $importActive ? 'active' : '' }}"
            data-bs-toggle="collapse" aria-expanded="{{ $importActive ? 'true' : 'false' }}" aria-controls="freightImportMenu">
    ...
    <div class="nav-item-group">
        ...
        <a href="#freightSettingsMenu"
            class="nav-link {{ $settingsActive ? 'active' : '' }}"
            data-bs-toggle="collapse" aria-expanded="{{ $settingsActive ? 'true' : 'false' }}" aria-controls="freightSettingsMenu">
