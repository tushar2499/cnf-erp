...
@push('styles')
    <style>
        ...
        .cus-tabs .cus-tab:hover:not(.active) {
            color: #0d9488;
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content" style="border:none; border-radius:.75rem; overflow:hidden;">
                <div class="modal-header text-white border-0"
                    style="background:linear-gradient(135deg,#0d2626 0%,#1a3d3d 60%,#14b8a6 100%); padding:1rem 1.25rem;">
                    <div>
                ...
                <form id="customerForm">
                        ...
                        <div class="tab-content p-3">
                            ...
                            <div class="tab-pane fade show active" id="tabBasic">
                                ...
                                <div class="cus-section mb-3">
                                    <div class="cus-section-header"
                                        style="background:#e0f7f4; border-left:4px solid #14b8a6;">
                                    ...
                                    <div class="row g-2 pt-2">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="input-group input-group-sm">
                                                <input type="text" id="cusCustomerId"
                                                    class="form-control bg-light fw-600" readonly>
                                                <button type="button" class="btn btn-sm" id="btnGenCusId"
                                                    style="background:#14b8a6;color:#fff;" title="Regenerate"><i
                                ...
                                <div class="cus-section mb-3">
                                    <div class="cus-section-header"
                                        style="background:#e8f4fd; border-left:4px solid #1565c0;">
                                        <i class="fa fa-building me-2" style="color:#1565c0;"></i><span>General</span>
                                    </div>
                                    <div class="row g-2 pt-2">
                                        <div class="col-12">
                                            <label class="form-label">Customer / Company Name <span
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" id="cusSalesPerson"
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" id="cusContactPerson"
                                                class="form-control form-control-sm">
                                        </div>
                                        <div class="col-12">
                                ...
                                <div class="cus-section mb-3">
                                    <div class="cus-section-header"
                                        style="background:#fef3e2; border-left:4px solid #f59e0b;">
                                ...
                                <div class="cus-section">
                                    <div class="cus-section-header"
                                        style="background:#f3e8ff; border-left:4px solid #7c3aed;">
                                        <i class="fa fa-file-invoice me-2" style="color:#7c3aed;"></i><span>Tax &amp;
                                            Identity</span>
                                    </div>
                                    <div class="row g-2 pt-2">
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" id="cusOtherPrefix"
                                                class="form-control form-control-sm">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cus-section">
                                    ...
                                    <div class="row g-2 pt-2">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" id="cusPostalCode"
                                                class="form-control form-control-sm">
                                        </div>
                                        <div class="col-12">
                            ...
                            <div class="tab-pane fade" id="tabFinancial">
                                ...
                                <div class="cus-section mb-3">
                                    <div class="cus-section-header"
                                        style="background:#e8f4fd; border-left:4px solid #1565c0;">
                                        <i class="fa fa-credit-card me-2" style="color:#1565c0;"></i><span>Payment &amp;
                                            Tax</span>
                                    </div>
                                    <div class="row g-2 pt-2">
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="number" id="cusDiscount" class="form-control form-control-sm"
                                                value="0" min="0" step="0.01">
                                        </div>
                                        <div class="col-md-4">
                                            <label class="form-label">Commission (%)</label>
                                            <input type="number" id="cusCommission" class="form-control form-control-sm"
                                                value="0" min="0" step="0.01">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cus-section mb-3">
                                    <div class="cus-section-header"
                                        style="background:#fef3e2; border-left:4px solid #f59e0b;">
                                        <i class="fa fa-hand-holding-usd me-2" style="color:#f59e0b;"></i><span>Credit
                                            &amp; Limits</span>
                                    </div>
                                    <div class="row g-2 pt-2">
                                        <div class="col-md-3">
                                            <label class="form-label">Credit Limit</label>
                                            <input type="number" id="cusCreditLimit"
                                                class="form-control form-control-sm" value="0" min="0"
                                                step="0.01">
                                        </div>
                                        <div class="col-md-3">
                                            <label class="form-label">Limit Days</label>
                                            <input type="number" id="cusLimitDays" class="form-control form-control-sm"
                                                value="0" min="0">
                                        </div>
                                        <div class="col-md-3">
                                            <label class="form-label">Security Deposit</label>
                                            <input type="number" id="cusSecurityDeposit"
                                                class="form-control form-control-sm" value="0" min="0"
                                                step="0.01">
                                        </div>
                                        <div class="col-md-3">
                                            <label class="form-label">Maturity Days</label>
                                            <input type="number" id="cusMaturityDays"
                                                class="form-control form-control-sm" value="0" min="0">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cus-section">
                                    ...
                                    <div class="row g-2 pt-2">
                                        <div class="col-md-6">
                                            <label class="form-label">Password <small class="text-muted">(leave blank to
                                                    keep)</small></label>
                                            <input type="password" id="cusPassword" class="form-control form-control-sm">
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label">Confirm Password</label>
                                            <input type="password" id="cusPasswordConfirm"
                                                class="form-control form-control-sm">
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="modal-footer border-top" style="background:#f8fffe;">
                        ...
                        <button type="submit" class="btn btn-sm px-4 text-white" id="btnSave"
    ...
    <script>
        ...
        $(function() {
            ...
            function generateCusId() {
                $.getJSON('{{ route('chevron.stakeholders.customers.next-id') }}', {
                    prefix: $('#cusPrefix').val()
                }, function(r) {
                    $('#cusCustomerId').val(r.customer_id);
                });
            }

            $('#cusPrefix').on('change', function() {
                if (!$('#cusId').val()) generateCusId();
            });
            ...
            function resetForm() {
                ...
                $('#cusCountry, #cusDivision, #cusDistrict, #cusCity, #cusRegion, #cusPostalCode, #cusCusIdRef')
                    .val('');
            ...
            $('#customerForm').on('submit', function(e) {
                ...
                const id = $('#cusId').val();
                const url = id ? '{{ url('chevron/stakeholders/customers') }}/' + id :
                    '{{ route('chevron.stakeholders.customers.store') }}';
                ...
                $.ajax({
                        ...
                        data: {
                            ...
                            name: $('#cusName').val(),
                            branch_id: $('#cusBranch').val(),
                            owner_name: $('#cusOwnerName').val(),
                            address: $('#cusAddress').val(),
                            phone: $('#cusPhone').val(),
                            fax: $('#cusFax').val(),
                            mobile: $('#cusMobile').val(),
                            email: $('#cusEmail').val(),
                            sales_person: $('#cusSalesPerson').val(),
                            customer_account: $('#cusAccount').val(),
                            vat_id: $('#cusVatId').val(),
                            identity_type: $('#cusIdentityType').val(),
                            tin_bin_nid: $('#cusTinBinNid').val(),
                            contact_person_details: $('#cusContactPerson').val(),
                            prefix: $('#cusOtherPrefix').val(),
                            status: $('#cusStatus').val(),
                            country: $('#cusCountry').val(),
                            division: $('#cusDivision').val(),
                            district: $('#cusDistrict').val(),
                            city: $('#cusCity').val(),
                            region: $('#cusRegion').val(),
                            postal_code: $('#cusPostalCode').val(),
                            customer_id_reference: $('#cusCusIdRef').val(),
                            pay_type: $('#cusPayType').val(),
                            taxscope: $('#cusTaxscope').val(),
                            discount: $('#cusDiscount').val(),
                            commission: $('#cusCommission').val(),
                            credit_limit: $('#cusCreditLimit').val(),
                            limit_days: $('#cusLimitDays').val(),
                            security_deposit: $('#cusSecurityDeposit').val(),
                            maturity_days: $('#cusMaturityDays').val(),
                            portal_password: $('#cusPassword').val(),
                            portal_password_confirm: $('#cusPasswordConfirm').val(),
                        },
                    })
                    .done(function(r) {
