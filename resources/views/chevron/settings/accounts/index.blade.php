...
@push('styles')
    <style>
        ...
        #accountsTable thead tr:last-child th {
            background: #f8f9fa;
        }

        #accountsTable thead tr:last-child th input.form-control {
            min-width: 72px;
            width: 100%;
        ...
        .accounts-table-wrapper::-webkit-scrollbar-track {
            background: #f1f1f1;
        }
        ...
        #accountsTable_wrapper>.row:last-child {
            position: sticky;
            bottom: 0;
            background: #fff;
            z-index: 3;
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    <li><button class="dropdown-item"
                            onclick="$('#accountsTable').DataTable().button('.buttons-csv').trigger()"><i
                                class="fa fa-file-csv me-2 text-secondary"></i>CSV</button></li>
                    <li><button class="dropdown-item"
                            onclick="$('#accountsTable').DataTable().button('.buttons-excel').trigger()"><i
                                class="fa fa-file-excel me-2 text-success"></i>Excel</button></li>
                    <li><button class="dropdown-item"
                            onclick="$('#accountsTable').DataTable().button('.buttons-pdf').trigger()"><i
                                class="fa fa-file-pdf me-2 text-danger"></i>PDF</button></li>
                    <li>
                        <hr class="dropdown-divider">
                    </li>
                    <li><button class="dropdown-item"
                            onclick="$('#accountsTable').DataTable().button('.buttons-print').trigger()"><i
                    ...
                    <div class="modal-body">
                        <div class="row g-2">
                            <div class="col-md-6">
                                ...
                                <input type="text" id="fldAccountNo" class="form-control form-control-sm"
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" id="fldAccountName" class="form-control form-control-sm"
                                    placeholder="Account holder name" required>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Bank Name</label>
                                <input type="text" id="fldBankName" class="form-control form-control-sm"
                                    placeholder="e.g. Dutch-Bangla Bank">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Branch Name</label>
                                <input type="text" id="fldBranchName" class="form-control form-control-sm"
    ...
    <script>
        ...
        $(function() {
            table = $('#accountsTable').DataTable({
                ...
                language: {
                    emptyTable: '<div class="text-center py-3 text-muted"><i class="fa fa-inbox fa-2x mb-2 d-block"></i>No accounts yet.</div>'
                },
            });
            ...
            $('#accountForm').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    .fail(function(xhr) {
                        if (xhr.status === 422) {
                            const map = {
                                account_no: '#fldAccountNo',
                                account_name: '#fldAccountName',
                                bank_name: '#fldBankName',
                                branch_name: '#fldBranchName'
                            };
