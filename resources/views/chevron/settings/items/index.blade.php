...
@push('styles')
    <style>
        ...
        .item-tabs .item-tab:hover:not(.active) {
            color: #1565c0;
        ...
        #itemsTable thead tr:last-child th {
            background: #f8f9fa;
        }

        #itemsTable thead tr:last-child th input.form-control {
            min-width: 72px;
            width: 100%;
        ...
        #itemsTable_wrapper>.row:last-child {
            position: sticky;
            bottom: 0;
            background: #fff;
            z-index: 3;
    ...
    <div class="card">
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    <li><button class="dropdown-item"
                            onclick="$('#itemsTable').DataTable().button('.buttons-csv').trigger()"><i
                                class="fa fa-file-csv me-2 text-secondary"></i>CSV</button></li>
                    <li><button class="dropdown-item"
                            onclick="$('#itemsTable').DataTable().button('.buttons-excel').trigger()"><i
                                class="fa fa-file-excel me-2 text-success"></i>Excel</button></li>
                    <li><button class="dropdown-item"
                            onclick="$('#itemsTable').DataTable().button('.buttons-pdf').trigger()"><i
                                class="fa fa-file-pdf me-2 text-danger"></i>PDF</button></li>
                    <li>
                        <hr class="dropdown-divider">
                    </li>
                    <li><button class="dropdown-item"
                            onclick="$('#itemsTable').DataTable().button('.buttons-print').trigger()"><i
        ...
        <div class="card-body p-0">
            <div class="items-table-wrapper">
                <table id="itemsTable" class="table table-hover table-striped table-bordered mb-0">
                    <thead>
                        <tr>
                            <th>#</th>
                            <th>Item Code</th>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content" style="border:none; border-radius:.75rem; overflow:hidden;">
                <div class="modal-header text-white border-0"
                    style="background:linear-gradient(135deg,#1a2a6c 0%,#1565c0 60%,#1e88e5 100%); padding:1rem 1.25rem;">
                    <div>
                            ...
                            <div class="tab-pane fade show active" id="tabItemEntry">
                                ...
                                <div class="item-section">
                                    ...
                                    <div class="row g-2 pt-2">
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" id="itemCode" name="item_code"
                                                class="form-control form-control-sm bg-light" placeholder="Auto-generated"
                                                readonly>
                                        </div>
                                        <div class="col-md-8">
                                            <label class="form-label">Item Name</label>
                                            <input type="text" id="itemName" name="item_name"
                                                class="form-control form-control-sm" placeholder="Full item name">
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label">Purchase Unit <span
                                                    class="text-danger">*</span></label>
                                            <select id="itemUnit" name="purchase_unit"
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" id="itemSupplier" name="supplier"
                                                class="form-control form-control-sm" placeholder="Supplier code or name">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="item-section">
                                    ...
                                    <div class="row g-2 pt-2">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="text" id="itemRemarks" name="remarks"
                                ...
                                <div class="item-section mb-0">
                                    <div class="item-section-header"
                                        ...
                                        <i class="fa fa-dollar-sign" style="color:#14b8a6;"></i><span>Pricing &amp;
                                            Settings</span>
                                    </div>
                                    <div class="row g-2 pt-2">
                                        <div class="col-md-4">
                                            <label class="form-label">Item Price <span
                                                    class="text-danger">*</span></label>
                                            <input type="number" id="itemPrice" name="item_price"
                                        ...
                                        <div class="col-md-4 d-flex align-items-end gap-3 pb-1">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="itemAvailPO"
                                                    name="availability_in_po" checked>
                                                <label class="form-check-label fw-500" for="itemAvailPO">Availability in
                                                    PO</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="itemAvailSO"
                                                    name="availability_in_so" checked>
                                                <label class="form-check-label fw-500" for="itemAvailSO">Availability in
                                                    SO</label>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="tab-pane fade" id="tabUploadImage">
                                <div class="item-section mb-0">
                                    ...
                                    <div class="row g-3 pt-2 pb-2">
                                        ...
                                        <div class="col-12">
                                            <label class="form-label">Choose Image <small class="text-muted">(JPG, PNG,
                                                    WEBP — max 2MB)</small></label>
        ...
        $(function() {
            table = $('#itemsTable').DataTable({
                ...
                initComplete: function() {
                    const firstRowH = $('#itemsTable thead tr:first-child').outerHeight();
                    $('#itemsTable thead tr:last-child th').css('top', firstRowH + 'px');
                ...
                language: {
                    emptyTable: '<div class="text-center py-3 text-muted"><i class="fa fa-inbox fa-2x mb-2 d-block"></i>No items yet.</div>'
                },
            });
            ...
            $('#itemForm').on('submit', function(e) {
                ...
                let valid = true;
                if (!$('#itemUnit').val()) {
                    $('#itemUnit').addClass('is-invalid').after(
                        '<div class="invalid-feedback">Purchase unit is required.</div>');
                    valid = false;
                }
                if (!valid) return;

                const id = $('#itemId').val();
                const url = id ? '{{ url('chevron/settings/items') }}/' + id :
                    '{{ route('chevron.settings.items.store') }}';
                ...
                $.ajax({
                    ...
                    .fail(function(xhr) {
                        if (xhr.status === 422) {
                            ...
                            if (errors.item_code) {
                                $('#itemCode').addClass('is-invalid').after(
                                    '<div class="invalid-feedback">' + errors.item_code[0] +
                                    '</div>');
                                $('#itemTabs a[href="#tabItemEntry"]').tab('show');
                            }
                            if (errors.purchase_unit) {
                                $('#itemUnit').addClass('is-invalid').after(
                                    '<div class="invalid-feedback">' + errors.purchase_unit[0] +
                                    '</div>');
                            }
                            if (errors.item_price) {
                                $('#itemPrice').addClass('is-invalid').after(
                                    '<div class="invalid-feedback">' + errors.item_price[0] +
                                    '</div>');
                            }
                        } else {
                            Swal.fire({
                    ...
                    .always(() => $('#btnSave').prop('disabled', false).html(
                        '<i class="fa fa-save me-1"></i> Save'));
            });
