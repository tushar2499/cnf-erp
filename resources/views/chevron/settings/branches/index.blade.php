...
@push('styles')
<style>
#branchesTable th, #branchesTable td { white-space: nowrap; font-size: .73rem; padding: .3rem .5rem; }
#branchesTable thead th { background: #e9ecef; font-weight: 600; position: sticky; z-index: 2; top: 0; }
#branchesTable thead tr:last-child th { background: #f8f9fa; }
#branchesTable thead tr:last-child th input.form-control { min-width: 72px; width: 100%; box-sizing: border-box; }
.branches-table-wrapper { max-height: 65vh; overflow: auto; }
.branches-table-wrapper::-webkit-scrollbar { width: 6px; height: 6px; }
.branches-table-wrapper::-webkit-scrollbar-track { background: #f1f1f1; }
.branches-table-wrapper::-webkit-scrollbar-thumb { background: #c1c1c1; border-radius: 3px; }
#branchesTable_wrapper > .row:last-child { position: sticky; bottom: 0; background: #fff; z-index: 3; border-top: 1px solid #dee2e6; margin: 0; padding: 6px 12px; }
</style>
@endpush
