    ...
    <script>
        ...
        $(function() {
            table = $('#branchesTable').DataTable({
                ...
                language: {
                    emptyTable: '<div class="text-center py-3 text-muted"><i class="fa fa-inbox fa-2x mb-2 d-block"></i>No branches yet.</div>'
                },
            });
            ...
            $('#branchForm').on('submit', function(e) {
                ...
                if (!$('#branchName').val().trim()) {
                    $('#branchName').addClass('is-invalid').after(
                        '<div class="invalid-feedback">Name is required.</div>');
                    return;
                }
                if (!$('#branchCode').val().trim()) {
                    $('#branchCode').addClass('is-invalid').after(
