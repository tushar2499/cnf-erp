...
@push('styles')
    <style>
        ...
        #jobsTable thead tr:last-child th {
            background: #f8f9fa;
        }

        #jobsTable thead tr:last-child th input.form-control {
            min-width: 72px;
            width: 100%;
        ...
        #jobsTable_wrapper>.row:last-child {
            position: sticky;
            bottom: 0;
            background: #fff;
            z-index: 3;
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li><button class="dropdown-item"
                                onclick="$('#jobsTable').DataTable().button('.buttons-csv').trigger()"><i
                                    class="fa fa-file-csv me-2 text-secondary"></i>CSV</button></li>
                        <li><button class="dropdown-item"
                                onclick="$('#jobsTable').DataTable().button('.buttons-excel').trigger()"><i
                                    class="fa fa-file-excel me-2 text-success"></i>Excel</button></li>
                        <li><button class="dropdown-item"
                                onclick="$('#jobsTable').DataTable().button('.buttons-pdf').trigger()"><i
                                    class="fa fa-file-pdf me-2 text-danger"></i>PDF</button></li>
                        <li>
                            <hr class="dropdown-divider">
                        </li>
                        <li><button class="dropdown-item"
                                onclick="$('#jobsTable').DataTable().button('.buttons-print').trigger()"><i
        ...
        $(function() {
            var table = $('#jobsTable').DataTable({
                ...
                columns: [{
                    ...
                    {
                        data: 'invoice_value_1_fmt',
                        name: 'invoice_value_1',
                        className: 'text-end'
                    },
                    {
                        data: 'invoice_value_2_fmt',
                        name: 'invoice_value_2',
                        className: 'text-end'
                    },
                    {
                        data: 'assessable_value_fmt',
                    ...
                    {
                        data: 'assessable_value_bdt_fmt',
                        name: 'assessable_value_bdt',
                        className: 'text-end'
                    },
                    {
                        data: 'duty_amount_fmt',
                        name: 'duty_amount',
                        className: 'text-end'
                    },
                    {
                    ...
                    {
                        data: 'net_payable_1_fmt',
                        name: 'net_payable_1',
                        className: 'text-end'
                    },
                    {
                        data: 'net_payable_2_fmt',
                        name: 'net_payable_2',
                        className: 'text-end'
                    },
                    {
