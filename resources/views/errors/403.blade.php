...
<head>
    ...
    <title>403 — Access Forbidden — NAS Group ERP</title>
...
<body>
    <div class="err-wrap">
        ...
        <i class="fa fa-lock err-icon" aria-hidden="true"></i>
        <div class="err-title">Access Forbidden</div>
        <p class="err-msg">
            {{ $exception->getMessage() ?: "You don't have permission to access this page." }}<br>
