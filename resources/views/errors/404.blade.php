...
<head>
    ...
    <title>404 — Page Not Found — NAS Group ERP</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .err-code { font-size: 7rem; font-weight: 800; color: #14b8a6; line-height: 1; letter-spacing: -5px; }
        .err-icon { font-size: 2.2rem; color: #14b8a6; opacity: .65; margin: .75rem 0 .25rem; display: block; }
        ...
        .btn-teal:hover { background: #0f9c8c; color: #fff; }
        .btn-ghost {
            display: inline-flex; align-items: center; justify-content: center; gap: .35rem;
...
<body>
    <div class="err-wrap">
        ...
        <i class="fa fa-magnifying-glass err-icon" aria-hidden="true"></i>
        <div class="err-title">Page Not Found</div>
        <p class="err-msg">
            {{ $exception->getMessage() ?: "The page you're looking for doesn't exist or may have been moved." }}
        </p>
        <div class="d-flex gap-2 justify-content-center flex-wrap">
            <button type="button" onclick="history.back()" class="btn-ghost">
                <i class="fa fa-arrow-left" aria-hidden="true"></i> Go Back
            </button>
            <a href="{{ url('/') }}" class="btn-teal">
