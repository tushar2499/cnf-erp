...
<head>
    ...
    <title>419 — Page Expired — NAS Group ERP</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .err-code { font-size: 7rem; font-weight: 800; color: #64b5f6; line-height: 1; letter-spacing: -5px; }
        .err-icon { font-size: 2.2rem; color: #64b5f6; opacity: .65; margin: .75rem 0 .25rem; display: block; }
...
<body>
    <div class="err-wrap">
        ...
        <i class="fa fa-clock-rotate-left err-icon" aria-hidden="true"></i>
        <div class="err-title">Page Expired</div>
        <p class="err-msg">
            Your session token has expired. This usually happens after a long period of inactivity.<br>
        ...
        <div class="d-flex gap-2 justify-content-center flex-wrap">
            ...
            <button type="button" onclick="location.reload()" class="btn-blue">
                <i class="fa fa-rotate-right" aria-hidden="true"></i> Refresh Page
            </button>
        </div>
        <hr class="sep">
