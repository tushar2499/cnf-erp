...
<div class="d-flex justify-content-between align-items-center mb-3">
    <h4 class="mb-0"><i class="fa fa-code-branch me-2 text-info"></i> Branches</h4>
...
<div class="panel" style="background:#fff;border:1px solid #dee2e6;border-radius:.5rem;overflow:hidden;">
    <div style="background:#0c2340;color:#fff;padding:.6rem 1rem;font-weight:600;font-size:.85rem;"><i class="fa fa-list me-2"></i> All Branches</div>
    <div style="overflow-x:auto">
        <table id="branchesTable" class="table table-hover table-striped mb-0 w-100">
            <thead style="background:#1a6b60;color:#fff;">
                <tr><th>#</th><th>Name</th><th>Code</th><th>Address</th><th>Phone</th><th>Status</th><th>Action</th></tr>
            </thead>
            <tbody></tbody>
        </table>
    </div>
        ...
        <div class="modal-content">
            ...
            <form id="branchForm">
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        <div class="col-md-8">
                            <label class="form-label" style="font-size:.82rem;font-weight:600">Branch Name <span class="text-danger">*</span></label>
                            <input type="text" id="branchName" class="form-control form-control-sm" placeholder="e.g. Chittagong Branch">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label" style="font-size:.82rem;font-weight:600">Code</label>
                            <input type="text" id="branchCode" class="form-control form-control-sm" placeholder="e.g. CGP" maxlength="20" style="text-transform:uppercase">
                        </div>
                        <div class="col-12">
