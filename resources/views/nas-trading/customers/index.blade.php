                ...
                <div class="p-3">
                    <form id="mainForm">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="text" id="fCode" class="form-control form-control-sm bg-light fw-bold"
                        ...
                        <div class="row g-2 mb-3">
                            <div class="col-6">
                                ...
                                <input type="number" id="fCreditLimit" class="form-control form-control-sm" value="0"
                                    step="0.01">
                            </div>
                            <div class="col-6">
                        ...
                        <div class="d-flex gap-2">
                            <button type="submit" class="btn btn-success btn-sm px-4" id="btnSave"><i
                                    class="fa fa-save me-1"></i> Save</button>
                            <button type="button" class="btn btn-outline-secondary btn-sm" id="btnCancel"><i
    ...
    <script>
        ...
        $(function() {
            ...
            $('#mainForm').on('submit', function(e) {
                ...
                const id = $('#recId').val();
                const url = id ? '{{ url('nas-trading/customers') }}/' + id :
                    '{{ route('nas-trading.customers.store') }}';
                ...
                $.ajax({
                    ...
                    .fail(function(xhr) {
                        if (xhr.status === 422) {
                            ...
                            if (e.company_name) {
                                $('#fCompanyName').addClass('is-invalid');
                                $('#fNameErr').text(e.company_name[0]);
                            }
                        } else Swal.fire({
                            icon: 'error',
