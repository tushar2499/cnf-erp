...
<head>
<meta charset="UTF-8">
<title>LC Closing Statement — {{ $lcBillStatement->bill_no }}</title>
<style>
...
.doc { width: 100%; max-width: 1000px; margin: 0 auto; background: #fff; padding: 24px 28px; }
...
.subject { margin:8px 0 4px; font-size:11px; }
.doc-title { text-align:center; font-weight:bold; font-size:13px; margin:10px 0 10px; }
table { width:100%; border-collapse:collapse; }
table th, table td { border:1px solid #000; padding:4px 6px; font-size:9px; }
