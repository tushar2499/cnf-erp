...
<head>
    <meta charset="UTF-8">
    <title>C&F Bills — NAS/C&FBS/{{ $lcBillStatement->bill_no }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    @php
        function cnfDuesNumberToWords(float $amount): string
        {
    ...
    <div id="print-wrap">
        @foreach ($lcBillStatement->items as $item)
            ...
            <div class="doc">
                ...
                <div class="in-word">
                    <strong>In Word:</strong> BDT {{ cnfDuesNumberToWords($dues) }} only.
                </div>
