...
<head>
    <meta charset="UTF-8">
    <title>LC Commission Bills — LC/CBL/{{ $lcBillStatement->bill_no }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="text-right">
                                {{ $item->lc?->lc_rt_value ? number_format($item->lc->lc_rt_value, 2) : '-' }}</td>
                            <td class="text-center">
                                {{ $item->lc?->lc_commission_percent ? rtrim(rtrim(number_format($item->lc->lc_commission_percent, 4), '0'), '.') . '%' : '-' }}
                            </td>
