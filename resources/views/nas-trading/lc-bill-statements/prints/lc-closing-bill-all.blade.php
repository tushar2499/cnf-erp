        ...
        @foreach ($lcBillStatement->items as $item)
            ...
            <div class="doc">
                ...
                <table>
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="2" class="text-right" style="border-left:1px solid #000;font-weight:bold;">
                                Total Cost BDT.</td>
                            <td class="text-right" style="font-weight:bold;">{{ number_format($totalCost, 2) }}</td>
                        </tr>
                        <tr>
                            <td colspan="2" class="text-right" style="border-left:1px solid #000;">(-) Advance BDT.
                            </td>
