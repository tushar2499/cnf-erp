...
#expenseHeadTable_wrapper>.row:last-child {
...
<div class="page-header">
    ...
    <button class="btn btn-sm btn-info text-white" data-bs-toggle="modal" data-bs-target="#expenseHeadModal" id="btnAddNew">
...
<div class="panel">
    <div class="panel-header d-flex justify-content-between align-items-center">
        <span><i class="fa fa-list me-2"></i> Expense Head List</span>
        <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
                <li><button class="dropdown-item" onclick="$('#expenseHeadTable').DataTable().button('.buttons-csv').trigger()"><i class="fa fa-file-csv me-2 text-secondary"></i>CSV</button></li>
                <li><button class="dropdown-item" onclick="$('#expenseHeadTable').DataTable().button('.buttons-excel').trigger()"><i class="fa fa-file-excel me-2 text-success"></i>Excel</button></li>
                <li><button class="dropdown-item" onclick="$('#expenseHeadTable').DataTable().button('.buttons-pdf').trigger()"><i class="fa fa-file-pdf me-2 text-danger"></i>PDF</button></li>
                <li>
                    <hr class="dropdown-divider">
                </li>
                <li><button class="dropdown-item" onclick="$('#expenseHeadTable').DataTable().button('.buttons-print').trigger()"><i class="fa fa-print me-2"></i>Print</button></li>
            </ul>
        </div>
    </div>
    <div class="dt-scroll">
        <table id="expenseHeadTable" class="table table-hover table-striped table-bordered dt-table mb-0 w-100">
            <thead>
            <tr>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="modal-title fw-600" id="expenseHeadModalTitle"><i class="fa fa-plus me-2"></i> Add Expense Head</h6>
...
var table;
$(function () {
    table = $('#expenseHeadTable').DataTable({
        ...
        columns: [
            ...
            { data: 'name',         name: 'name' },
            { data: 'category',     name: 'category',     width: '120px' },
        ...
        initComplete: function () {
            const firstRowH = $('#expenseHeadTable thead tr:first-child').outerHeight();
            $('#expenseHeadTable thead tr:last-child th').css('top', firstRowH + 'px');
    ...
    function resetForm() {
        ...
        $('#expenseHeadModalTitle').html('<i class="fa fa-plus me-2"></i> Add Expense Head');
    ...
    $(document).on('click', '.btn-edit', function () {
        ...
        $.getJSON('{{ url('nas-trading/expense-heads') }}/' + id, function (r) {
            ...
            $('#expenseHeadModalTitle').html('<i class="fa fa-edit me-2"></i> Edit Expense Head');
