...
return new class extends Migration
{
    ...
    {
        Schema::table('nas_freights_rfqs', function (Blueprint $table) {
            $table->dropForeignIdFor(\App\Models\NasFreights\NasFreightsOverseasAgent::class, 'overseas_agent_id');
            $table->dropForeignIdFor(\App\Models\NasFreights\NasFreightsShippingCarrier::class, 'shipping_carrier_id');
